...
background: radial-gradient(circle, rgba(255,255,255,1) 16%, rgba(155,201,255,1) 100%);
}
...
<div class="flex flex-col justify-center">
        <input id="searchInput" class="px-4 py-2 border border-gray-300 rounded-md" type="text" placeholder="Search">
    </div>
    <br><br>    
    <div class="flex flex-wrap justify-center gap-3" id="freelancersContainer">
        @foreach ($freelancers as $freelancer)
            <div class="freelancerCard w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg">
    ...
    <script>
        document.getElementById('searchInput').addEventListener('input', function(event) {
            ...
            var freelancerCards = document.querySelectorAll('.freelancerCard');

            freelancerCards.forEach(function(card) {
                var freelancerData = JSON.parse(card.querySelector('.freelancer-details').getAttribute('data-freelancer'));
                var freelancerName = freelancerData.user.name.toLowerCase();
                var freelancerFonction = freelancerData.fonction.toLowerCase();

                if (freelancerName.includes(searchQuery) || freelancerFonction.includes(searchQuery)) {
...
<div class="popup-card hidden fixed top-0 left-0 w-full h-full flex  justify-center bg-gray-800 bg-opacity-75">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="description mt-2 w-3/4 m-auto"></div>
            <br>
            <div class="flex justify-between px-2">
                <div class="flex flex-col ">
                    <div class="fonction"></div>
                    <div class="">Experience : <span class="experience font-bold"></span>years</div>
                </div>
                
                <div class="location mt-2 font-bold"></div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        freelancerCards.forEach(card => {
            card.addEventListener('click', function () {
                ...
                popupCard.querySelector('.description').textContent = freelancerData.discreption;
                popupCard.querySelector('.location').textContent = freelancerData.lieux;
                popupCard.querySelector('.fonction').textContent = freelancerData.fonction;
                popupCard.querySelector('.experience').textContent = freelancerData.experience;
