...
<body class="oooo">
      ...
      <div class=" flex flex-wrap items-center justify-between my-2 mx-4">
        ...
        <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <a href="{{route('profile.edit')}}" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Profile</a>
            </li>
            <li>
  ...
  <div class="flex flex-col justify-center items-center">
    ...
    <div class="flex flex-wrap gap-2 px-3">
      ...
      <div class="group w-[400px] h-[80px] shadow-lg rounded-lg bg-slate-100  p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3] flex justify-between">
        <div>
          <p class="bg-gradient-to-r from-zinc-900 to-indigo-600 bg-clip-text text-transparent text-2xl">Total Utilisateurs:</p>
      ...
      <div class="group w-[400px] h-[80px] shadow-lg rounded-lg bg-slate-100  p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3] flex justify-between">
        <div>
          <p class="bg-gradient-to-r from-zinc-900 to-indigo-600 bg-clip-text text-transparent text-2xl"> Total Enterprises:
          </p>
      ...
      <div class="group w-[400px] h-[80px] shadow-lg rounded-lg bg-slate-100  p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3] flex justify-between">
        <div>
          <p class="bg-gradient-to-r from-zinc-900 to-indigo-600 bg-clip-text text-transparent text-2xl"> Total Jobs:
          </p>
  ...
  <div class="flex flex-wrap relative justify-center gap-5">
    ...
    <div id="jobCardsContainer" class="flex flex-col items-center">
      ...
      <div class="bg-gradient-to-l from-slate-300 to-slate-100 text-slate-600 border border-slate-300 grid grid-col-2 rounded-lg  p-4 gap-4  w-[500px] hover:-translate-y-2 hover:shadow-xl shadow-gray-800">
        ...
        <div id="like">
          <svg onclick="toggleColors(this , '{{ $jobe->id }}')" id="likeIcon" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
            <g id="SVGRepo_bgCarrier" stroke-width="0" />
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
            <g id="SVGRepo_iconCarrier">
              <path id="heartPath" d="M2 9.1371C2 14 6.01943 16.5914 8.96173 18.9109C10 19.7294 11 20.5 12 20.5C13 20.5 14 19.7294 15.0383 18.9109C17.9806 16.5914 22 14 22 9.1371C22 4.27416 16.4998 0.825464 12 5.50063C7.50016 0.825464 2 4.27416 2 9.1371Z" fill="#ffffff" />
            </g>
          </svg>
        </div>
        ...
        <div id="cardContent{{ $jobe->id }}" class="hidden sticky top-0 overflow-hidden">
    ...
    <script>
      function toggleColors(svgElement, projectId) {
        ...
        var data = 'jobe_id=' + projectId;

        xhr.open('POST', '/job/like', true);
  ...
  <footer class=" text-center text-surface/75  dark:text-white/75 lg:text-left" style="background: rgb(16,22,128);
background: linear-gradient(0deg, rgba(16,22,128,1) 0%, rgba(45,253,251,0) 100%);">
    <div class="flex items-center justify-center  lg:justify-center dark:text-gray-800 ">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <!-- Products section -->
        <div>
          <h6 class="mb-4 text-grey-800 flex justify-center font-semibold uppercase md:justify-start">
            Products
          </h6>
          <p class="mb-4">
            <a href="#!">HTML</a>
    ...
    <div class=" p-6 text-center">
      ...
      <a class="font-semibold" href="#"> <span class="workwise text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-orange-500">Work-Wise</span>
      </a>
    </div>
  </footer>
</body>
